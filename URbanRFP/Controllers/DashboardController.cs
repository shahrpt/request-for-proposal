...
namespace ICMA.Controllers
{
    ...
    public class DashboardController : BaseController
    {
        ...
        [RoleAuthorize("Vendor,RFP,Admin")]
        ...
        public ActionResult Product(string prd_key= "")
        {
            var response = _productFacade.Find(prd_key);

            if(response.Success)
                return View(response.Result);
            else
            {
                return View(new RfpProduct());
            }
        ...
        [RoleAuthorize("Vendor")]
        public ActionResult RFP()
        {
            return View("RFP");
        }

        public ActionResult RfpResponse()
        {
            return View();
        }
    }
